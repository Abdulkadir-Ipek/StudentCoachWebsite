...
<head>
    ...
    <title>Şifremi Unuttum - EduCoach</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="form-container">
        ...
        <p class="form-description">Lütfen hesabınıza bağlı e-posta adresinizi girin. Size şifre sıfırlama bağlantısı göndereceğiz.</p>
